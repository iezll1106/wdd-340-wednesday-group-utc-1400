...
export default function ProductCard({ product }: ProductProps) {
  return (
      <Link className="border border-gray-200 rounded-lg shadow-lg p-4 bg-white hover:shadow-xl transition max-w-[250px]" href={`/dashboard/products/${product.id}`}>
        <Image 
        ...
        <div className="flex justify-between items-center mt-3">
          ...
          {/* onClick={()=>{orderProduct(product, "3f54dab7-fcf5-4d5b-ac89-a5bcc819be22");}} */}
